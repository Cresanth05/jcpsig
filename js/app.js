...
// changeBackgroundColorButton.addEventListener("click", () => {
  // const r = Math.round(Math.random() * 0);
  // const g = Math.round(Math.random() * 0);
  // const b = Math.round(Math.random() * 0);
...
//   const g = Math.round(Math.random() * 0);
//   const b = Math.round(Math.random() * 0);
    //  const a = Math.round(Math.random() * 0);
...
savePNGButton.addEventListener("click", () => {
  if (signaturePad.isEmpty()) {
    ...
    download(dataURL, "PSC-MSSC(PH).png");
  }
});
